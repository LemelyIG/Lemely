...
function Header({ onOpenNav }: { onOpenNav: () => void }) {
  ...
  return (
    ...
    // bypasses it.
    <header className="lm-app-header lm-nav-chrome flex items-center gap-[18px] px-page-mobile min-[640px]:px-page-desktop py-4 border-b border-rule bg-paper/80 backdrop-blur-nav sticky top-0 z-nav">
