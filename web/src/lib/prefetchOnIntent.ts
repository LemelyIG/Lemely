 ...
 * intent to visit `/student/correct` (the Header CTA, the BottomNav
 * "Correct" tab). One call, one fire-once gate: hovering the CTA and then
 * focusing the tab must still only import the chunk once, not once per
 * handler.
 */
