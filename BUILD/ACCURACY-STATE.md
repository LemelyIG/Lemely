...
last_run_headline: PROGRAMME RETIRED under human ruling C26 (DA51). NOT DONE — retired. Section 13: clause 1 NOT MET (8 non-H sub-issues open at close, plus 6 off-epic defects), clause 2 PARTIAL (gate runs on every CI test job, review_rate_ratchet_armed=False at config.py:190 so it observes and does not block), clause 3 MET (by publishing an absence), clause 4 NOT MET (**ZERO of ~300 labels — eval/labels/ holds only .gitkeep**), clause 5 PARTIAL (both halves measured, neither at the clause's scope), clause 6 NOT MET, clause 7 MET (#159 open, LEFT OPEN per 12.3 at the human's instruction), clause 8 MET. 3 MET / 2 PARTIAL / 3 NOT MET — and NOT ONE of the eight is met by the programme having produced the outcome it set out to produce; three are met by being honest about not producing it. *** ALL 24 ISSUES CLOSED AS NOT PLANNED. ZERO COMPLETED. #136 was going to be the one exception and did not survive adversarial review: bullets 1-5 hold (blocking.json all four schemes delta 0 EXACT, both regression test classes present, verified at source) but bullet 6 asks for '#95 unblocked or its route re-decided' and FINDINGS.md ends with #95 NOT EXECUTABLE AS WRITTEN, three options, explicit 'no recommendation'. I had verified the checkable bullets and taken the last on trust — the same move this retirement criticises #28 for. *** M0 DID NOT MEET ITS ACCEPTANCE EITHER: all 12 sub-issues of #24 closed, but box 3 needs the extraction/marking/masked split and THE 2x2 DOES NOT EXIST — #28 closed as COMPLETED with all four boxes UNTICKED, ablation_2x2() returns b=c=n_pairs=0. THE QUESTION THE PROGRAMME WAS BUILT TO ANSWER HAS NO MEASUREMENT. *** OBJECTIVE UNMET IN ALL THREE PARTS: no attribution measurement; review rate 32.58% vs a 10% budget and NO trajectory sayable (C16 removed the start point, 19.1% retracted); catch rate FELL — flag_recall 14.29% n=71 vs the 27.3% the >=6/11 target was set from. *** SEVEN STALE FIGURES FOUND IN ACCURACY-REPORT.md WHILE RETIRING IT, all corrected: clause 5 '331 of 479' (DA50 falsified it that morning; 393/1130=34.8%); spend 5.993470 -> 6.370451; '3 luckiest of 10' -> FOUR at the minimum; 'exceeds 7 times in 10' -> 10 of 10; constant 29.03% -> 0.4838; defaulted rates 44.4%/21.6% -> 34.26%/8.94%; and the det coverage table MIXED DENOMINATORS (parsed for the era rows, source for the total) making the old decade read 20.7% when the source-basis figure is 9.5% — 589 of 651 pre-2019 schemes have NO reconciling parse. NONE was caught by a gate, a test or CI; every one was found by a person reading prose. THE CONTROLS BIND CODE AND DO NOT BIND PROSE. That list is what ONE pass found and is not proof the file is clean. *** Spend 6.370451 of 8.00, four ledgers re-read at close. Final account: BUILD/ACCURACY-FINAL-REPORT.md.
