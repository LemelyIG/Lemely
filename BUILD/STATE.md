...
CURRENT SURFACE:    Auth DONE (7 of 10 built; admin deferred behind D1.6).
                    Next: **Marketing / landing** -> 404/misc -> admin.
NEXT ACTION:        Phase 4, surface 9: **Marketing / landing**
                    (`portals/student/screens/Landing.tsx` and
                    `Directions.tsx`). This is a design-taste-frontend
                    surface (§3.2 item 15 makes it authoritative there),
                    dials VARIANCE 7 / MOTION 7 / DENSITY 4, and it is the
                    largest remaining block of `font-serif` call sites.
                    Audit findings C1/C2/C3 (fabrications) were already fixed
                    in Phase 2 — do not re-fix them, and do not add new
                    numbers: §3.2 item 10 bans invented metrics outright.

                    Surface 7 (admin views) stays **deferred, not skipped**,
                    behind D1.6. Re-asked 2026-08-14T02:45, still unanswered.
                    Take it up the moment an answer arrives; if Marketing and
                    404/misc both finish with it still open, THAT is where
                    Phase 4 genuinely blocks.

                    New since surface 8, and binding on every later surface:
...
LAST UPDATED:       2026-08-14T03:20+03:00
